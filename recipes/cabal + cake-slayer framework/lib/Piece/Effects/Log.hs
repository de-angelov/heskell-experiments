-- | Logging action for the project. Currently just logs the output to terminal.Binary
...
-- | Runs application as servant 'Handelr' . 
...
-- |  Like 'runsAppAsIO' but discards result.
